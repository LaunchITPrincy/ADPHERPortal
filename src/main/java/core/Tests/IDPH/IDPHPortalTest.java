...
public class IDPHPortalTest extends BaseTest {
	...
	//Apply For a Program BackFlow Tester
	...
	//EMS Provider - AEMT SubType

	@Test(priority = 79, description = "Verify to Apply EMS Provider Program with the subtype AEMT", enabled = true)
	...
	@Test(priority = 80, description = "Verify the Program Type and Subtype must be displayed or not based on the ApplyProgram page selection.", enabled = true)
	...
	@Test(priority = 81, description = "Verify to Fill informations in the the EMS Provider program, with the subtype AEMT", enabled = true)
	public void Verify_AEMT_ApplicationForms (Method method) throws InterruptedException {

		ExtentTestManager.startTest(method.getName(), "Verify to Fill informations in the the EMS Provider program, with the subtype AEMT");
	...
	@Test(priority = 82, description = "Verify the EMS Provider program Personal Informations.", enabled = true)
	public void EMSProvider_PersonalInformation(Method method) throws InterruptedException {

		ExtentTestManager.startTest(method.getName(), "Verify the EMS Provider program Personal Informations.");
	...
	@Test(priority = 83, description = "Verify EMS Provider Personal Informations Required Fields", enabled = true)
	public void EMSProvider_PersonalInformation_RequiredFields(Method method) throws InterruptedException {

		ExtentTestManager.startTest(method.getName(), "Verify EMS Provider Personal Informations Required Fields");
	...
	@Test(priority = 84, description = "Verify to Personal Informations Gender field dropdown Values", enabled = true)
	...
	@Test(priority = 85, description = "Verify the Application Form Current National Registry Questions for EMS Providers", enabled = true)
	...
	@Test(priority = 86, description = "Verify Current National Registry dropdown values", enabled = true)
	...
	@Test(priority = 87, description = "If the NREMT Number and Expiration Date are both blank, a verification alert message must be displayed.", enabled = true)
	...
	@Test(priority = 88, description = "Verify if the expiration date, entered as a date in the past, requires an alert to be displayed or not.", enabled = true)
	...
	@Test(priority = 89, description = "Verify the Application Form Provider Disaster Questions for EMS Providers", enabled = true)
	...
	@Test(priority = 90, description = "Verify Application Form Provider Disaster Required Fields", enabled = true)
	...
	@Test(priority = 91, description = "Verify the Application Form Fee Waiver Request Questions for EMS Providers", enabled = true)
	...
	@Test(priority = 92, description = "Verify Application Form Fee Waiver Request Required Fields", enabled = true)
	...
	@Test(priority = 93, description = "Verify EMS Providers Fee Waiver Request Federal Poverty Level Dropdown values", enabled = true)
	...
	@Test(priority = 94, description = "Verify EMS Providers Fee Waiver Request House hold Income Dropdown values.", enabled = true)
	...
	@Test(priority = 95, description = "Verify to Upload Files and Click Upload attachments. System must display View button with attachment Description", enabled = true)
	public void AEMT_UploadAttachments (Method method) throws InterruptedException, IOException {

		ExtentTestManager.startTest(method.getName(), "Verify to Upload Files and Click Upload attachments. System must display View button with attachment Description");
	...
	@Test(priority = 96, description = "Verify If you agree to the Terms and Conditions and click the Continue button, you must be taken to the Payment Page.", enabled = true)
	...
	@Test(priority = 97, description = "Verify If you click the Pay Now button, you must be taken to another Make Payment page.", enabled = true)
	...
	@Test(priority = 98, description = "To Verify If Payment Successful system must navigate to Paramedic Payment Receipt Page.", enabled = true)
	...
	@Test(priority = 99, description = "Verify to apply Duplicate EMS Provider Program, with the Subtype AEMT.", enabled = true)
	public void ApplyforProgramDuplicate_AEMT  (Method method) throws InterruptedException {

		ExtentTestManager.startTest(method.getName(), "Verify to apply Duplicate EMS Provider Program, with the Subtype AEMT.");
	...
	//EMS Provider - EMR SubType
	
	@Test(priority = 100, description = "Verify to Apply EMS Provider Program with the subtype EMR", enabled = true)
	...
	@Test(priority = 101, description = "Verify the Program Type and Subtype must be displayed or not based on the ApplyProgram page selection.", enabled = true)
	...
	@Test(priority = 102, description = "Verify to Fill informations in the the EMS Provider program, with the subtype EMR", enabled = true)
	...
	@Test(priority = 103, description = "Verify the upload of attachments with documents.", enabled = true)
	...
	@Test(priority = 104, description = "Verify If you agree to the Terms and Conditions and click the Continue button, you must be taken to the Payment Page.", enabled = true)
	...
	@Test(priority = 105, description = "Verify If you click the Pay Now button, you must be taken to another Make Payment page.", enabled = true)
	...
	@Test(priority = 106, description = "Verify to enter valid payment information to proceed", enabled = true)
	...
	@Test(priority = 107, description = "Verify to apply Duplicate EMS Provider Program, with the Subtype EMR", enabled = true)
	...
	//EMS Provider - EMS Student 
	
	@Test(priority = 108, description = "Verify to Apply EMS Provider Program with the subtype EMS Student", enabled = true)
	...
	@Test(priority = 109, description = "Verify The Program Type and Subtype must be displayed or not based on the ApplyProgram page selection.", enabled = true)
	...
	@Test(priority = 110, description = "Verify to Fill informations in the the EMS Provider program, with the subtype EMS Student", enabled = true)
	...
	@Test(priority = 111, description = "Verify AEMT must have an active EMT License", enabled = true)
	...
	@Test(priority = 112, description = "Verify Paramedic must have an active AEMT or EMT License", enabled = true)
	...
	@Test(priority = 113, description = "Verify the upload of attachments with documents.", enabled = true)
	...
	@Test(priority = 114, description = "Verify If you agree to the Terms and Conditions and click the Continue button, you must be taken to the Payment Page.", enabled = true)
	...
	@Test(priority = 115, description = "Verify to Apply EMS Provider Program with the subtype EMT", enabled = true)
	...
	@Test(priority = 116, description = "Verify The Program Type and Subtype must be displayed or not based on the ApplyProgram page selection.", enabled = true)
	...
	@Test(priority = 117, description = "Verify to Fill informations in the the EMS Provider program, with the subtype EMT", enabled = true)
	...
	@Test(priority = 118, description = "Verify the upload of attachments with documents.", enabled = true)
	...
	@Test(priority = 119, description = "Verify If you agree to the Terms and Conditions and click the Continue button, you must be taken to the Payment Page.", enabled = true)
	...
	@Test(priority = 120, description = "Verify If you click the Pay Now button, you must be taken to another Make Payment page.", enabled = true)
	...
	@Test(priority = 121, description = "Verify to enter valid payment information to proceed", enabled = true)
	...
	@Test(priority = 122, description = "Verify to apply Duplicate EMS Provider Program, with the Subtype EMT.", enabled = true)
	...
	@Test(priority = 123, description = "Verify to Apply EMS Provider Program with the subtype Paramedic", enabled = true)
	...
	@Test(priority = 124, description = "Verify The Program Type and Subtype must be displayed or not based on the ApplyProgram page selection.", enabled = true)
	...
	@Test(priority = 125, description = "Verify to Fill informations in the the EMS Provider program, with the subtype Paramedic", enabled = true)
	...
	@Test(priority = 126, description = "Verify the upload of attachments with documents.", enabled = true)
	...
	@Test(priority = 127, description = "Verify If you agree to the Terms and Conditions and click the Continue button, you must be taken to the Payment Page.", enabled = true)
	...
	@Test(priority = 128, description = "Verify If you click the Pay Now button, you must be taken to another Make Payment page.", enabled = true)
	...
	@Test(priority = 129, description = "Verify to enter valid payment information to proceed", enabled = true)
	...
	@Test(priority = 130, description = "Verify to apply Duplicate EMS Provider Program, with the Subtype Paramedic.", enabled = true)
